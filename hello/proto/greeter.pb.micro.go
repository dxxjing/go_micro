...
func (c *greeterService) Hello(ctx context.Context, in *HelloReq, opts ...client.CallOption) (*HelloRsp, error) {
...
func (h *greeterHandler) Hello(ctx context.Context, in *HelloReq, out *HelloRsp) error {
